...
import com.geekbrains.server.authorization.UserNotFoundException;
...
public class ClientHandler {
    ...
    private void sendAuthorizationMessage(boolean authenticated) throws IOException {
        outputStream.writeBoolean(authenticated);
    }

    public void authentication() throws IOException, UserNotFoundException {
        while (true) {
            String message = inputStream.readUTF();
